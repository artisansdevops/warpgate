#!/usr/bin/env bash
# start.sh — build and start the RabbitMQ test stack, then seed it via the admin API.
set -euo pipefail
...
info "Seeding test user, role and RabbitMQ targets..."
ADMIN_TOKEN="$ADMIN_TOKEN" bash "$SCRIPT_DIR/seed.sh" "$HTTP_PORT" "$ADMIN_TOKEN"

echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN} RabbitMQ test stack is ready!${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
echo ""
echo -e "  ${CYAN}RabbitMQ via warpgate:${NC} amqp://rabbitmquser%23my-rabbitmq:RabbitPass123!@localhost:5672/"
echo ""
echo -e "  Run the smoke test: ${CYAN}./scripts/test-rabbitmq-target.sh${NC}"
